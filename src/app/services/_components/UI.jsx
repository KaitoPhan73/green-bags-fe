...
export const UI = () => {
  ...
  return (
    <>
      <main className="pointer-events-none select-none fixed inset-0 flex flex-col justify-between">
        {/* <div className="flex justify-center items-center" style={{ width: '1000px', height: '700px' }}>
