...
//           setUploadedImages(updatedImages); // Update state with uploaded images
//           setTempUploadFiles([]); // Clear temporary files after upload
//           setIsUploadModalVisible(false); // Close the upload modal after upload
//         }
//       };
...
//       {/* Display uploaded images directly */}
//       <div className="uploaded-images mt-4">
//         <Row gutter={[16, 16]} className="mr-20 ml-20 justify-center">
//           {uploadedImages.map((image, index) => (
//             <Col key={index} span={8} className="justify-center">
...
//                 height={100}
//                 className="cursor-pointer"
//                 onClick={() => onImageSelect(image)} // Select image on click
//               />
//             </Col>
//           ))}
//         </Row>
...
//           <Button
//             onClick={handleUploadSelect}
//             disabled={tempUploadFiles.length === 0 || tempUploadFiles.length > 5} // Disable if no files or more than 5
//           >
//             Chấp Nhận Các Ảnh
//           </Button>
//         }
...
//           multiple={true}
//           onChange={handleUploadChange}
//           disabled={uploadedImages.length >= 5} // Disable upload if 5 images already uploaded
//         >
//           <div>
//             <PlusOutlined />
//             <div style={{ marginTop: 8 }}>Upload</div>
